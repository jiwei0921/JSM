...
class fusion(nn.Module):
    def __init__(self, in_channel=32, out_channel=32):
        ...
        self.up8 = nn.Upsample(scale_factor=4, mode='bilinear', align_corners=True)
        self.up16 = nn.Upsample(scale_factor=8, mode='bilinear', align_corners=True)
        self.up32 = nn.Upsample(scale_factor=16, mode='bilinear', align_corners=True)
