...
class Saldepth(nn.Module):
    def __init__(self):
        super(Saldepth, self).__init__()
    ...
    def forward(self,images,depths,pred_sal):

        '''Generating the saliency Depth'''
        depth_pos = self.HA(pred_sal.sigmoid(),depths)
